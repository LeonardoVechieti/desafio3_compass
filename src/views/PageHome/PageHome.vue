<template>
  <div class="page-home">
    <div class="header">
      <div class="logo">
        <MyImg image="logo2" desc="logo" class="" id="image-logo" />
      </div>
    ...
    <div class="container">
      <div class="image">
        <img src="@/assets/uol.png" alt="" />
      </div>
      <div class="message">
        <MyText size="size-24px" text="Our mission is" id="red-bold" />
        <MyText size="size-24px" text="Nossa missão é" id="black" />
        <MyText size="size-40px" text="to transform the world" id="red-bold" />
        <MyText size="size-20px" text="transformar o mundo" id="black" />
        <MyText
          size="size-40px"
    ...
    <div class="footer">
      <div class="text1">
        ...
        <MyText
          size="size-13px"
          text=" Deixe-a aberta em segundo plano e abra uma nova janela para continuar a navegar."
        />
      </div>
      <div class="text2">
      ...
      <div class="buttons">
        <div class="button1" @click="continuar()">
          <MyText size="size-16px" text="Continuar Navegando" id="black" />
        </div>
        <div class="button2" @click="logout()">
          <MyText size="size-16px" text="Logout" />
        </div>
      </div>
    </div>
  </div>
